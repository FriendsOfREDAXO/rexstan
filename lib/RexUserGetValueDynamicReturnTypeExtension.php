...
final class RexUserGetValueDynamicReturnTypeExtension implements DynamicMethodReturnTypeExtension
{
    public function getClass(): string
    {
        return rex_user::class;
    }
    ...
    public function getTypeFromMethodCall(
        ...
        $resultType = $queryReflection->getResultType('SELECT * FROM rex_user', QueryReflector::FETCH_TYPE_ASSOC);
